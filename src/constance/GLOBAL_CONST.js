const GLOBAL_CONST = {
  github: "https://github.com/RyanMStewart",
  linkedin: "https://www.linkedin.com/in/ryan-michael-stewart/",
  description:
    "continually fueling my own growth is what drives me. I've found my sweet spot in team environments, where I channel my natural flair for software development.\nI pour heart and soul into my craft, injecting creativity into every logical problem that comes my way.I'm a software maestro fluent in a symphony of languages,\nbut Swift and Go are the stars of the show. But hey, I'm no one-trick pony! With substantial hands-on experience of over 5 years with React, and Ruby on Rails under my belt,\nI also boast of a Ruby Association Certification which solidifies my prowess in Ruby.",
  skillsList: [
    {
      id: 1,
      title: "React",
